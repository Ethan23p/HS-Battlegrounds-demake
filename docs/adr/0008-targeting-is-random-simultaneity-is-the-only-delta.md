...
> **Corrected by [ADR 0010](0010-an-attack-is-an-exchange.md) on two points.** The table
...
| An attack | Damages both Units — the target answers with its own attack | Unchanged — see [ADR 0010](0010-an-attack-is-an-exchange.md) |
...
[ADR 0010](0010-an-attack-is-an-exchange.md), which found "removal is deferred to the end
