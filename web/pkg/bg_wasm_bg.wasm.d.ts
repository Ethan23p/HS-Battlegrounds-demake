...
export const apply_fight_result: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
export const end_turn: (a: number, b: number, c: number, d: number) => [number, number, number, number];
...
export const start_new_round: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const start_run: (a: number, b: number, c: bigint) => [number, number, number, number];
